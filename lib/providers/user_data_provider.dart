...
class UserDataProvider extends BaseUserDataProvider {
  ...
  Future<bool> addNewDeliveryUser(Map deliveryUserMap) async {
    try {
      ...
      var refundRes = await http.post(
        'URL_HERE', //TODO: change this URL //it should look something like : https://us-********-**********.cloudfunctions.net/createDeliveryUserAccount
        body: map,
      );
  ...
  Future<String> sendNewNotification(Map map) async {
    try {
      ...
      //call function
      var refundRes = await http.post(
        'URL_HERE', //TODO: change this URL //it should look something like : https://us-********-**********.cloudfunctions.net/sendNewNotification
        body: notifMap,
      );
